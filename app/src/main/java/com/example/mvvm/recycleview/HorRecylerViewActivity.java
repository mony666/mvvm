...
public class HorRecylerViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRvhor.setAdapter(new HorAdapter(HorRecylerViewActivity.this, new HorAdapter.OnItemClickListener() {
    ...
    class MyDecoration extends RecyclerView.ItemDecoration {
        ...
        public void getItemOffsets(@NonNull Rect outRect, @NonNull View view, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
            ...
            outRect.set(0, 0, getResources().getDimensionPixelOffset(R.dimen.dividerHegoht), 0);
        }
    }
}